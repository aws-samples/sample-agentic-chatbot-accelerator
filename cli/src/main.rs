...
//!
//! Scaffold stage (T1): installs the process-wide TLS baseline and proves one
...
///
/// Folded into T4's config fetch once that lands; it exists so this task has an
...
pub async fn tls_smoke_check(url: &str) -> anyhow::Result<u16> {
